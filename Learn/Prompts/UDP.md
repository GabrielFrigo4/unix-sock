...
- **O Cabeçalho Microscópico:** Disseque a estrutura bruta de 32 bits do cabeçalho UDP. Analise a função das portas de origem e destino, o campo de comprimento (incluindo o próprio cabeçalho) e o campo de Checksum. Contraste essa simplicidade com o _overhead_ tradicional de protocolos orientados a conexão.
