 ...
 *Defina e explique meticulosamente cada um dos níveis abaixo, dissecando o caminho físico dos bytes (Disco -> RAM -> Rede) e as chamadas de sistema envolvidas:*
 ...
 * **Técnico:** É MANDATÓRIO o uso rigoroso de termos de hardware e C (ex: `sendfile`, `copy_file_range`, `mmap`, *Context Switch*, *Page Cache*, *ARC*, *PCIe BAR*, *Inodes*, *DMA*, *NUMA Nodes*, *AVX/SIMD*, *File Descriptors*).
