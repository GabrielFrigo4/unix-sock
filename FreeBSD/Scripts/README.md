...
| **[`openzfs.sh`](<./kvm/openzfs.sh>)** | 📟 *Guest (VM)* | Configura o particionamento do disco alvo (GPT/EFI), inicializa o pool ZFS (`zroot`), cria os datasets base e prepara o bootloader UEFI. |
